...
class FadingFilterHoming:
    ...
    def update(self, pursuer_pos, pursuer_vel, pursuer_old_acc):
        ...
        self.gamma_dot = np.append(self.gamma_dot, pursuer_old_acc/self.chase_vel)

    def get_estimation(self, pursuer_pos, pursuer_vel, pursuer_old_acc):
        self.update(pursuer_pos, pursuer_vel, pursuer_old_acc)
